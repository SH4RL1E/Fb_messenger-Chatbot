...
module.exports.run = async function({ api, event, args }) {
		...
		const prefix = "🤣";
		const CREATORLINK = "https://www.facebook.com/profile.php?id=61550011623347";
		const BOTCREATOR = "Charlie Ocoy";
		const BOTNAME = "Sh4rleyy";
		const FILESOWNER = "Charlie, //credit sa mismong owner ng GoatBot";
